      ...
      <div className="w-full bg-[#0a0c10] p-12 md:p-24 relative overflow-hidden text-white">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto mb-24">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 leading-tight">
            ...
            <span className="font-dancing text-primary italic">Insights</span> and <span className="font-dancing text-primary italic">Updates</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 bg-white/5 p-2 rounded-2xl sm:rounded-full border border-white/10 max-w-md mx-auto min-h-[50px] sm:min-h-0">
            ...
            />
            <button className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-full font-bold transition-all whitespace-nowrap w-full sm:w-auto">
              Subscribe
            </button>
          </div>
        </div>
